...
export function SiteFooter({ note = "Hybrid Next.js preview" }: { note?: string }) {
  return (
    <footer className="border-t border-gold/25 bg-[#081630] py-10 text-cream/70">
      ...
      <div className="mx-auto mt-8 max-w-6xl border-t border-cream/10 px-5 pt-5 text-xs text-cream/45 md:px-8">
        © {new Date().getFullYear()} Kareem Jamal · {note}
      </div>
    </footer>
  );
}
